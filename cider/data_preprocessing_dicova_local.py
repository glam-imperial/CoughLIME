    ...
    def __init__(self, dset, fold_id,
        ...
        if dataset == 'dicova':
            if modality == 'cough' and dset != 'test':
                path = f'/Users/anne/Documents/Uni/Robotics/Masterarbeit/MA_Code/DICOVA/DiCOVA_Train_Val_Data_Release'
                indexes = "File_name"
            elif modality == 'cough' and dset == 'test':
                path = '../DiCOVA_Track_1_Evaluation_Release'
                indexes = "File_name"
    ...
    def __getitem__(self, index):
        ...
        if self.dataset == 'dicova':
            if self.modality == 'cough' and self.dset != 'test':
                audio_path = '/Users/anne/Documents/Uni/Robotics/Masterarbeit/MA_Code/DICOVA/DiCOVA_Train_Val_Data_Release/AUDIO/' + audio_name + '.flac'
