...
def make_graph(comps, values, save_path):
    ...
    plt.title("Percentage of correct explanations per k components")
    plt.xticks(comps)

    plt.xlabel("Number of components")
    plt.ylabel("Percentage of correct explanations")
    plt.legend()
...
if __name__ == "__main__":
    components = [1, 3, 5, 7]
    path_text_files = '/Users/anne/PycharmProjects/LIME_cough/quantitative_evaluation'
